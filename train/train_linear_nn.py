...
from models.regression.LinearNN import LinearNN as LinearNN
...
if args.regression:
	if args.shared:
		# Regression task
		model = LinearNN(S_D = components, shared=True)
		...
		# Regression task
		model = LinearNN(S_D = components, shared=False)
	...
	print("Linear model only supports regression")
